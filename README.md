...
much smaller scale. Tests live in `sqlite/tests/test_db.c` and drive the compiled
REPL as a black box: they pipe a script into its stdin and compare stdout line by
line.
